...
import dayjs from 'dayjs';
import { fullGradeList, middleBookVolumeList, middleSchoolBookPublisherList, middleSchoolSubjectList, primaryBookPublisherList, primaryBookVolumeList, primarySubjectList, seniorBookVolumeList, seniorSchoolBookPublisherList, seniorSubjectList } from '../modalContent/config';
...
export class IndexMobx {
  ...
  eduPhaseRelateFilter = (eduPhase: string, needResetSelect: boolean = false, needRefreshSubjectList: boolean = true) => {
    if (eduPhase == '2') {
      this.setInfo({
    ...
    if (needRefreshSubjectList) {
      this.setInfo({
        eduSubjectList: eduPhase === '2' ? primarySubjectList :
          eduPhase === '4' ? middleSchoolSubjectList :
            eduPhase === '6' ? seniorSubjectList : []
      })
    }
  }
